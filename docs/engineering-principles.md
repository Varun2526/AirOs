...
*(Introduced in [Document 01](engineering/01-hand-landmarks-and-coordinate-system.md))*
...
*(Introduced in [Document 02](engineering/02-data-pipeline.md))*
...
*(Introduced in [Document 03](engineering/03-recorder-and-replay.md))*
